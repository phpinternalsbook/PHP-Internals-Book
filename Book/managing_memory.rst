First step into code : Managing memory
======================================

Nobody can start programming inside PHP without knowing this layer. So we’ll
start by introducing how to allocate/free/debug memory within PHP using the
Zend Memory Manager layer
